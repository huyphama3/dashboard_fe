...
const menuGroups = [
  {
    ...
    menuItems: [
      ...
      //Quản Lý Nhân viên
      {
        ...
        route: "#",
        children: [
          { label: "Bui Trong La", route: "/tables/bui-trong-la" },
          { label: "Huỳnh Thị Lệ Trinh", route: "/tables/huynh-thi-le-trinh" },
          { label: "Phùng Vĩnh Duy", route: "/tables/phung-vinh-duy" },
          { label: "Đậu Quang Cường", route: "/tables/dau-quang-cuong" },
        ],
      },
      {
        icon: (
        ...
        route: "#",
        children: [
          { label: "Form Điền Thông Tin", route: "/forms/form-layout" },
        ],
      },
    ],
  },
